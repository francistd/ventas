...
class clientes
{
  public function agregaClientes($datos){
    ...
    $sql="INSERT INTO clientes (id_usuario,nombre,apellido,direccion,email,telefono,rfc,active)
    values ('$idusuario','$datos[0]','$datos[1]','$datos[2]','$datos[3]','$datos[4]','$datos[5]','$active')";
...
public function eliminaCliente($idcliente){
  ...
  $sql = "UPDATE clientes SET active=0 where id_cliente='$idcliente'";
